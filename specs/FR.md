...
1. Общеиспользуемые атрибуты для хранимых данных
    ...
    1. Время изменения - updated
    1. Активность Контента - active
    1. Архивное хранения Контента - archived
    1. Типы вопросов - qtype
    1. Владелец - owner
    1. Порядок - ordernum
1. Общие условия возможности изменить Контент
